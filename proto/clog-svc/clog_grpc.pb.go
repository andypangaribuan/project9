...
const (
	CLogService_ServiceLog_FullMethodName = "/clog_svc.CLogService/ServiceLog"
	CLogService_InfoLog_FullMethodName    = "/clog_svc.CLogService/InfoLog"
	CLogService_DbqLog_FullMethodName     = "/clog_svc.CLogService/DbqLog"
)
...
func (c *cLogServiceClient) ServiceLog(ctx context.Context, in *RequestServiceLog, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, CLogService_ServiceLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cLogServiceClient) DbqLog(ctx context.Context, in *RequestDbqLog, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, CLogService_DbqLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CLogService_ServiceLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CLogService_ServiceLog_FullMethodName,
	}
...
func _CLogService_DbqLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CLogService_DbqLog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CLogService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "files/proto/clog.proto",
}
